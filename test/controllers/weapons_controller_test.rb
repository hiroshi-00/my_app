...
class WeaponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weapon" do
    assert_difference('Weapon.count') do
      post weapons_url, params: { weapon: { img: @weapon.img, name: @weapon.name, no: @weapon.no } }
    end
  ...
  test "should update weapon" do
    patch weapon_url(@weapon), params: { weapon: { img: @weapon.img, name: @weapon.name, no: @weapon.no } }
